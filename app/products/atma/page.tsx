...
import {
  ...
  PAGE_CTA,
  USE_CASES,
} from "@/content/products/atma";

const product = PRODUCTS.find((p) => p.code === "SCN-03")!;

export const metadata: Metadata = {
  title: `${product.name} — Scaan Technologies`,
  description: `${product.name} (${product.code}): indigenous training lifecycle platform. Curricula, assessments, readiness, and skills analytics for Indian Defence training establishments.`,
};

/*
 * /products/atma — Task 3.2.
 * Composition mirrors /products/onecommand and /products/indea — the product
 * story is the variable, the page chrome is the constant.
 */
        ...
        <div className="mx-auto max-w-(--container-wrap) px-5 py-24 md:px-9 md:py-32">
          <Reveal>
            <SectionHeader
              number="01"
              label="Capabilities"
              lede="ATMA is built around the training lifecycle as it actually works inside Indian Defence establishments: authoring, delivery, and the readiness picture that comes out the other end."
            >
        ...
        <div className="mx-auto max-w-(--container-wrap) px-5 py-24 md:px-9 md:py-32">
          <Reveal>
            <SectionHeader
              number="02"
              label="Deployment"
              lede="Training data is sensitive. ATMA is engineered so the chain of custody from establishment to HQ matches the chain of command — and never crosses it."
            >
              Service-wide, but with{" "}
              <em className="italic font-normal text-navy">
                establishment-level sovereignty.
              </em>
            </SectionHeader>
          </Reveal>
      ...
      <section className="border-b border-line">
        <div className="mx-auto max-w-(--container-wrap) px-5 py-24 md:px-9 md:py-32">
          <Reveal>
            ...
            >
              How establishments are using{" "}
              <em className="italic font-normal text-navy">ATMA.</em>
            </SectionHeader>
          </Reveal>
