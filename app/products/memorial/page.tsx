...
import {
  ...
  PAGE_CTA,
  USE_CASES,
} from "@/content/products/memorial";

const product = PRODUCTS.find((p) => p.code === "SCN-06")!;

export const metadata: Metadata = {
  title: `${product.name} — Scaan Technologies`,
  description: `${product.name} (${product.code}): indigenous management platform for regimental museums, war memorials, and service archives. Collections, exhibits, visitor experience, and conservation engineered for long-horizon stewardship.`,
};
        ...
        <div className="mx-auto max-w-(--container-wrap) px-5 py-24 md:px-9 md:py-32">
          <Reveal>
            <SectionHeader
              number="01"
              label="Capabilities"
              lede="MEMORIAL is built around the three responsibilities heritage institutions actually carry: stewarding the collection, presenting it well, and accounting for its condition across time."
            >
              Collections, exhibits,{" "}
              <em className="italic font-normal text-navy">
                conservation — across decades.
              </em>
            </SectionHeader>
          </Reveal>
        ...
        <div className="mx-auto max-w-(--container-wrap) px-5 py-24 md:px-9 md:py-32">
          <Reveal>
            <SectionHeader
              number="02"
              label="Deployment"
              lede="Heritage records are intended to outlast the software that holds them. MEMORIAL's deployment posture is engineered around that reality — institutional ownership, open standards, and no vendor lock-in."
            >
              Records that{" "}
              <em className="italic font-normal text-navy">
                outlast the software.
              </em>
            </SectionHeader>
          </Reveal>
        ...
        <div className="mx-auto max-w-(--container-wrap) px-5 py-24 md:px-9 md:py-32">
          <Reveal>
            <SectionHeader
              number="03"
              label="Use Cases"
              lede="Anonymised examples drawn from active engagements. Institution names are illustrative."
            >
              How institutions are using{" "}
              <em className="italic font-normal text-navy">MEMORIAL.</em>
            </SectionHeader>
          </Reveal>
