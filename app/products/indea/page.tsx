...
import {
  ...
  PAGE_CTA,
  USE_CASES,
} from "@/content/products/indea";

const product = PRODUCTS.find((p) => p.code === "SCN-02")!;

export const metadata: Metadata = {
  title: `${product.name} — Scaan Technologies`,
  description: `${product.name} (${product.code}): indigenous sovereign AI platform for on-prem inference, retrieval, and mission-tuned reasoning over classified data.`,
};

/*
 * /products/indea — SPEC.md §6 (P1) and §10.2 (Task 2.5).
 * Reuses the ProductHero / CapabilityBlock / RelatedProducts shell defined
 * during Task 2.4. Composition mirrors /products/onecommand by design — the
 * product story is the variable, not the page chrome.
 */
export default function IndeaPage() {
  return (
    <>
      <ProductHero
        code={product.code}
        ...
        <div className="mx-auto max-w-(--container-wrap) px-5 py-24 md:px-9 md:py-32">
          <Reveal>
            <SectionHeader
              number="01"
              label="Capabilities"
              lede="INDEA is built around three load-bearing capabilities. Each is deployable on its own; together they form a sovereign reasoning surface for the operational data you cannot send elsewhere."
            >
              Inference, reasoning,{" "}
              <em className="italic font-normal text-navy">
                retrieval — on your terms.
              </em>
            </SectionHeader>
          </Reveal>
        ...
        <div className="mx-auto max-w-(--container-wrap) px-5 py-24 md:px-9 md:py-32">
          <Reveal>
            <SectionHeader
              number="02"
              label="Deployment"
              lede="AI shouldn't change the threat model of the data it reasons over. INDEA's deployment posture is engineered around that constraint."
            >
        ...
        <div className="mx-auto max-w-(--container-wrap) px-5 py-24 md:px-9 md:py-32">
          <Reveal>
            ...
            >
              ...
              <em className="italic font-normal text-navy">INDEA.</em>
            </SectionHeader>
          </Reveal>
