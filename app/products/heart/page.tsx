...
import {
  ...
  PAGE_CTA,
  USE_CASES,
} from "@/content/products/heart";

const product = PRODUCTS.find((p) => p.code === "SCN-04")!;

export const metadata: Metadata = {
  title: `${product.name} — Scaan Technologies`,
  description: `${product.name} (${product.code}): indigenous enterprise administration platform for Service HQs and the Ministry of Defence. Personnel records, forms and approvals, audit-complete workflows.`,
};
        ...
        <div className="mx-auto max-w-(--container-wrap) px-5 py-24 md:px-9 md:py-32">
          <Reveal>
            <SectionHeader
              number="01"
              label="Capabilities"
              lede="HEART is built around the three administrative surfaces that consume the most operational time inside Service HQs: personnel records, the approval chain, and the audit trail."
            >
              Records, approvals,{" "}
              <em className="italic font-normal text-navy">
                audit — built together.
              </em>
            </SectionHeader>
          </Reveal>
        ...
        <div className="mx-auto max-w-(--container-wrap) px-5 py-24 md:px-9 md:py-32">
          <Reveal>
            <SectionHeader
              number="02"
              label="Deployment"
              lede="Administrative data is sensitive. HEART's deployment posture is engineered so the chain of custody for personnel records matches the chain of command, with no third-party processors in the middle."
            >
              Customer-controlled,{" "}
              <em className="italic font-normal text-navy">
                chain-of-command aware.
              </em>
            </SectionHeader>
          </Reveal>
      ...
      <section className="border-b border-line">
        <div className="mx-auto max-w-(--container-wrap) px-5 py-24 md:px-9 md:py-32">
          <Reveal>
            ...
            >
              How HQs are using{" "}
              <em className="italic font-normal text-navy">HEART.</em>
            </SectionHeader>
          </Reveal>
